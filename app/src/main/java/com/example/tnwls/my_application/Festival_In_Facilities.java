...
import static com.example.tnwls.my_application.R.id.mapView;
 ...
 * 다음 지도 api 사용
 */
public class Festival_In_Facilities extends FragmentActivity implements MapView.OpenAPIKeyAuthenticationResultListener, MapView.MapViewEventListener, MapView.POIItemEventListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_festival_facility);
        ...
        ViewGroup mapViewContainer = (ViewGroup) findViewById(mapView);
        ...
        mButtonSearch.setOnClickListener(new View.OnClickListener() { // 검색버튼 클릭 이벤트 리스너
            ...
            public void onClick(View v) {
                ...
                latitude = geoCoordinate.latitude; // 위도
                longitude = geoCoordinate.longitude; // 경도
    ...
    private void showToast(final String text) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(Festival_In_Facilities.this, text, Toast.LENGTH_SHORT).show();
            }
        });
    }
